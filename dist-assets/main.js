...
addEventListener("load", () => {
  document.querySelectorAll(".datepicker, .daterangepicker").forEach(initializeDatepicker);
});
...
function attachToggleModal(triggerEl) {
  triggerEl.addEventListener("click", function(e) {
    ...
    e.stopPropagation();
    e.target.blur();
    const modalId = e.target.dataset.modalId || ((_a = e.target.closest(".modal")) == null ? void 0 : _a.id);
...
addEventListener("load", () => {
  ...
  function notify(message, type = "", timeout = 3e3) {
